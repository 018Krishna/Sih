        ...
        >
          ...
          <div style={{ width: '100%', padding: '19px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginTop: '30px' }}>
              <a href="/src/pages/OrganizationForm" style={{ padding: '10px 20px', backgroundColor: 'orange', color: '#FFF', textDecoration: 'none', borderRadius: '50px', cursor: 'pointer' }}>Get Started</a>
